...
```{r}
# STOCK PRICES
sp_500_prices_tbl <- readRDS("C:\\Users\\HP\\Downloads\\sp_500_prices_tbl.rds")
sp_500_prices_tbl
```
...
```{r}
# SECTOR INFORMATION
sp_500_index_tbl <- readRDS("C:\\Users\\HP\\Downloads\\sp_500_index_tbl.rds")
sp_500_index_tbl
```
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
stock_date_matrix_tbl <- read_rds("C:\\Users\\HP\\Downloads\\stock_date_matrix_tbl.rds")
```
...
We're going to import the correct results first (just in case you were not able to complete the last step).
```{r}
k_means_mapped_tbl <- read_rds("C:\\Users\\HP\\Downloads\\k_means_mapped_tbl.rds")
```
...
```{r}
k_means_mapped_tbl <- read_rds("C:\\Users\\HP\\Downloads\\k_means_mapped_tbl.rds")
umap_results_tbl   <- read_rds("C:\\Users\\HP\\Downloads\\umap_results_tbl.rds")
```
